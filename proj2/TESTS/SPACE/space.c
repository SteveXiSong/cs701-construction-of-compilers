...
)
{
 ...
 int pmin = 2147483647, pmax = (-2147483647 - 1), qmin = 2147483647, qmax = (-2147483647 - 1);
 app_ptr = gnode_ptr;
...
{
 struct Geomnode *app_ptr;
 double xmin = 1.7976931348623157e+308, xmax = 2.2250738585072014e-308, ymin = 1.7976931348623157e+308, ymax = 2.2250738585072014e-308;
 app_ptr = gnode_ptr;
 while (app_ptr != ((void *)0)) {
  if ((app_ptr->XA) < xmin)
   xmin = app_ptr->XA;
